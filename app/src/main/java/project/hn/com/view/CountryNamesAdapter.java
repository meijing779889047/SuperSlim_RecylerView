...
import project.hn.com.mylibrary.LinearSLM;
...
public class CountryNamesAdapter extends RecyclerView.Adapter<CountryViewHolder> {
    ...
    public CountryNamesAdapter(Context context, int headerMode) {
        ...
        for (int i = 0; i <mItems.size() ; i++) {
            Log.i("mj","text:"+mItems.get(i).text+"--->isHeader:"+mItems.get(i).isHeader+"-->manager:"+mItems.get(i).sectionManager+"-->position:"+mItems.get(i).sectionFirstPosition);
        }
    }
